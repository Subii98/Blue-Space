...
function RankPlayCount(props){
    ...
    const [rankPlayCount, setRankPlayCount] = useState(true)
            ...
            <div>
                ...
                <div className="rankPlayCount">
                    <div className="leaderboardHeader">
                        ...
                        <button disabled={true}>Play Count</button>
                    </div>
